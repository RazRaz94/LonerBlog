...
const makeIframeContent = (target) => {
  ...
  const iframeJsPath = target.dataset.iframe || `https://razraz94.github.io/LonerBlog/js/iframe.umd.js`;
  const cssPath = `https://razraz94.github.io/LonerBlog/css/cusdisstyle.css`;
  return `<!DOCTYPE html>
<html>
  <head>
