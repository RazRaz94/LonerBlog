(function($) {
    ...
    function ce(t, e, r, n, l, i, a, c = [-1]) {
        ...
        if (o.ctx = r ? r(t, e.props || {}, (u, v, ...k) => {
            ...
            }) : [], o.update(), f = !0, U(o.before_update), o.fragment = n ? n(o.ctx) : !1, e.target) {
            if (e.hydrate) {
                const u = Ue(e.target);
        ...
        Ye = function t(e) {
            ...
            function n(l, i, a, c) {
                ...
                return (o.fetch || fetch)(l, {
                    ...
                    return o.responseType == "stream" ? (s.data = g.body, s) : g[o.responseType || "text"]().then(function(L) {
            ...
            return e = e || {}, n.request = n, n.get = function(l, i) {
                return n(l, i, "get")
    ...
    function We(t) {
        let e, r, n, l = (t[1].moderator && t[1].moderator.displayName ? t[1].moderator.displayName : t[1].by_nickname) + "",
            i, a, c, s, o = t[1].parsedCreatedAt + "",
            f, u, v, k = t[1].parsedContent + "",
            g, b, m, L, M, E, C, N, _ = t[1].moderatorId && ve(),
            S = t[1].replies.data.length > 0 && Ce(t),
            h = t[0] && Le(t);
        return {
            c() {
                e = w("div"), r = w("div"), n = w("div"), i = x(l), a = R(), _ && _.c(), c = R(), s = w("div"), f = x(o), u = R(), v = w("div"), g = R(), S && S.c(), b = R(), m = w("div"), L = w("button"), L.textContent = `${A("reply_btn")}`, M = R(), h && h.c(), p(n, "class", "mr-2 font-medium dark:text-gray-100"), p(r, "class", "flex items-center"), p(s, "class", "text-gray-500 text-sm dark:text-gray-400"), p(v, "class", "text-gray-500 my-2 dark:text-gray-200"), p(L, "class", "font-medium text-sm text-gray-500 dark:bg-transparent dark:text-gray-100"), p(L, "type", "button"), p(e, "class", "my-4"), q(e, "pl-4", t[2]), q(e, "border-l-2", t[2]), q(e, "border-color-gray-200", t[2]), q(e, "cusdis-indicator", t[3])
            },
            m(y, z) {
                T(y, e, z), d(e, r), d(r, n), d(n, i), d(r, a), _ && _.m(r, null), d(e, c), d(e, s), d(s, f), d(e, u), d(e, v), v.innerHTML = k, d(e, g), S && S.m(e, null), d(e, b), d(e, m), d(m, L), d(e, M), h && h.m(e, null), E = !0, C || (N = F(L, "click", t[4]), C = !0)
            },
            p(y, [z]) {
                (!E || z & 2) && l !== (l = (y[1].moderator && y[1].moderator.displayName ? y[1].moderator.displayName : y[1].by_nickname) + "") && X(i, l), y[1].moderatorId ? _ ? _.p(y, z) : (_ = ve(), _.c(), _.m(r, null)) : _ && (_.d(1), _ = null), (!E || z & 2) && o !== (o = y[1].parsedCreatedAt + "") && X(f, o), (!E || z & 2) && k !== (k = y[1].parsedContent + "") && (v.innerHTML = k), y[1].replies.data.length > 0 ? S ? (S.p(y, z), z & 2 && O(S, 1)) : (S = Ce(y), S.c(), O(S, 1), S.m(e, b)) : S && (H(), j(S, 1, 1, () => {
                    S = null
                }), J()), y[0] ? h ? (h.p(y, z), z & 1 && O(h, 1)) : (h = Le(y), h.c(), O(h, 1), h.m(e, null)) : h && (H(), j(h, 1, 1, () => {
                    h = null
                }), J()), (!E || z & 4) && q(e, "pl-4", y[2]), (!E || z & 4) && q(e, "border-l-2", y[2]), (!E || z & 4) && q(e, "border-color-gray-200", y[2])
            },
            i(y) {
                E || (O(S), O(h), E = !0)
            },
    ...
    function Ge(t, e, r) {
        ...
        return t.$$set = o => {
            "comment" in o && r(1, n = o.comment), "showReplyForm" in o && r(0, l = o.showReplyForm), "isChild" in o && r(2, i = o.isChild)
        }, [l, n, i, a, c, s]
    }
    class Ee extends fe {
        constructor(e) {
            super(), ce(this, e, Ge, We, le, {
                comment: 1,
                showReplyForm: 0,
                isChild: 2
            })
    ...
    function Oe(t) {
        ...
        return s = E(t), o = M[s] = L[s](t), {
            c() {
                e = w("div"), m && m.c(), r = R(), re(n.$$.fragment), l = R(), i = w("div"), a = R(), c = w("div"), o.c(), f = R(), u = w("div"), v = R(), k = w("div"), g = w("a"), g.textContent = `${A("powered_by")}`, p(i, "class", "my-8"), p(c, "class", "mt-4 px-1"), p(u, "class", "my-8"), p(g, "class", "underline "), p(g, "href", "https://cusdis.com"), p(k, "class", "text-center text-gray-500 dark:text-gray-100 text-xs"), q(e, "dark", t[1] === "dark")
            },
            m(C, N) {
                T(C, e, N), m && m.m(e, null), d(e, r), Q(n, e, null), d(e, l), d(e, i), d(e, a), d(e, c), M[s].m(c, null), d(e, f), d(e, u), d(e, v), d(e, k), d(k, g), b = !0
            },
            p(C, N) {
                C[4] ? m ? m.p(C, N) : (m = Re(C), m.c(), m.m(e, r)) : m && (m.d(1), m = null);
                let _ = s;
                s = E(C), s === _ ? M[s].p(C, N) : (H(), j(M[_], 1, 1, () => {
                    M[_] = null
                }), J(), o = M[s], o ? o.p(C, N) : (o = M[s] = L[s](C), o.c()), O(o, 1), o.m(c, null)), (!b || N & 2) && q(e, "dark", C[1] === "dark")
            },
            i(C) {
    ...
    function Re(t) {
        ...
        return {
            c() {
                e = w("div"), r = x(t[4]), p(e, "class", "p-2 mb-4 bg-blue-500 text-white")
            },
            m(n, l) {
                T(n, e, l), d(e, r)
            },
    ...
    function Qe(t) {
        ...
        return {
            ...
            p(o, f) {
                f & 1 && (a = o[0].data, H(), e = be(e, f, c, 1, o, a, r, n.parentNode, ge, Ae, n, Me), J()), o[0].pageCount > 1 ? s ? s.p(o, f) : (s = Ie(o), s.c(), s.m(l.parentNode, l)) : s && (s.d(1), s = null)
            },
            i(o) {
                if (!i) {
    ...
    function Ve(t) {
        ...
        return {
            c() {
                e = w("div"), e.textContent = `${A("loading")}...`, p(e, "class", "text-gray-900 dark:text-gray-100")
            },
            m(r, n) {
                T(r, e, n)
            },
    ...
    function Te(t) {
        ...
        return {
            c() {
                e = w("button"), n = x(r), p(e, "class", "px-2 py-1 text-sm mr-2 dark:text-gray-200"), q(e, "underline", t[2] === t[14] + 1)
            },
            m(c, s) {
    ...
    function Xe(t) {
        ...
        return {
            ...
            p(l, [i]) {
                l[5] ? n && (H(), j(n, 1, 1, () => {
                    n = null
                }), J()) : n ? (n.p(l, i), i & 32 && O(n, 1)) : (n = Oe(l), n.c(), O(n, 1), n.m(e.parentNode, e))
            },
            i(l) {
                r || (O(n), r = !0)
            },
    ...
    function Ze(t, e, r) {
        ...
        me(() => {
            function b(m) {
                try {
                    ...
                    if (L.from === "cusdis") switch (L.event) {
                        case "setTheme":
                            r(1, o = L.data);
                            break
                    }
        ...
        }), Z("api", f), Z("attrs", n), Z("refresh", v), Z("setMessage", u);
        ...
        const g = (b, m) => k(b + 1);
        return t.$$set = b => {
            "attrs" in b && r(7, n = b.attrs), "commentsResult" in b && r(0, l = b.commentsResult)
        }, t.$$.update = () => {
